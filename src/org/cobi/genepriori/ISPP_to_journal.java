...
/**
 *
 * @author MX Li & Jacob Hsu
 */
public class ISPP_to_journal {
    ...
    public static void main(String[] args) {
        try {
            ...
            ISPP_to_journal app = new ISPP_to_journal();
    ...
    public List<String> generateFile(int[] attrIndex, String outputFile) {
        try {
            ...
            String[] ListContent = ReadFile("./Table1.txt");// This is for submitted journal 
